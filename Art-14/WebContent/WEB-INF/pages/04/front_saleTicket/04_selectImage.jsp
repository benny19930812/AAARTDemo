...
<!-- 		 				<div class="column col-xs-12 col-md-3 moreBox"> -->
...
<!--                             <div class="caption"> -->
<%--                                 <p class="group inner list-group-item-date"><span>${show.startdate} - ${show.enddate}</span> </p> --%>
<%--                                 <h4 class="group inner list-group-item-heading">${show.title}</h4> --%>
<%--                                 <div class="list-group-item-text">${show.site}</div> --%>
<!--                                 <p class="text-right"><input type=SUBMIT value="立即購買" class="genric-btn success-border radius"></p> -->
<!--                             </div> -->
<!--                         </div> -->
<%--                      </form> --%>
<%-- 		</c:forEach> --%>
